-- Reconcile branch locks: Business (additional-branch) = 3 base + addons (match get_branch_limit_for_owner).
...
BEGIN
  ...
  -- Business / additional-branch: 3 included + addons (same as get_branch_limit_for_owner)
